...
# What is Arinoglish? 
This is a special language invented by myself and it's currently being used in my imaginary nation: Arino

It's derived from Chinese and uses the same grammar and pronunciation as Chinese. The only difference is the writing system. 

Instead of using Chinese characters, Arinoglish uses a slightly modified version of the phonetic Chinese pinyin. 
